...
<head>
  ...
  <link hrfe="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-+0n0xVW2eSR5OomGNYDnhzAbDsOXxcvSN1TPprVMTNDbiYZCxYbOOl7+AMvyTG2x" crossorigin="anonymous">
  <title>Capacitancias en Paralelo</title>
</head>
    ...
    <div class="container-xl mt-5">
      ...
      <div class="card mt-3 card-dark bg-dark" style="width: 30rem;">
        <ul class="list-group list-group-flush">
          ...
          <?php $arr[$i] = $_REQUEST['capacitancias'][$i];
            $suma += $_REQUEST['capacitancias'][$i];
      ...
      $sql = "INSERT INTO capacitores (Operacion,Tipo,Calculo,Resultado) values ('Capacitor', 'Paralelo', '$calculo', '$resul')";
      $resultado = mysqli_query($con, $sql) or die('Error en el registro');
      mysqli_close($con);
      echo '<br><h4>Se guardo el calculo de Capacitor en <a href="historial.php">Historial</a></h4>';
      ?>
    </div>
  <?php
  } else {
